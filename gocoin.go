...
func tutorial(){
	...
	pricoin := C.CCPricoinGen( oParam1 )
	fmt.Printf("C_CCPricoinGen sucessful !\n")
	pubcoin := C.CCPubcoinGen( oParam1, pricoin )
	...
	coinspend := C.CCSpendGen( oParam1, pricoin, oAccum1, C.CString(toaddress))
